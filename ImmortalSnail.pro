...
unrealRootPath=/mnt/Texas/prj/ue4-4.24.3-html5
ImmortalSnailRootPath=/home/mika/prj/ImmortalSnail

gameProjectFile=/home/mika/prj/ImmortalSnail/ImmortalSnail.uproject
...
include(ImmortalSnailSource.pri)
include(ImmortalSnailHeader.pri)
include(ImmortalSnailConfig.pri)
include(ImmortalSnailIncludes.pri)
include(ImmortalSnailDefines.pri)

ImmortalSnail-Linux-Debug.commands = $$build ImmortalSnail Linux Debug  -project="\"$$gameProjectFile\"" $$args
ImmortalSnail-Linux-DebugGame.commands = $$build ImmortalSnail Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ImmortalSnail-Linux-Shipping.commands = $$build ImmortalSnail Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ImmortalSnail-Linux-Test.commands = $$build ImmortalSnail Linux Test  -project="\"$$gameProjectFile\"" $$args
ImmortalSnail.commands = $$build ImmortalSnail Linux Development  -project="\"$$gameProjectFile\"" $$args

ImmortalSnailEditor-Linux-Debug.commands = $$build ImmortalSnailEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ImmortalSnailEditor-Linux-DebugGame.commands = $$build ImmortalSnailEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ImmortalSnailEditor-Linux-Shipping.commands = $$build ImmortalSnailEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ImmortalSnailEditor-Linux-Test.commands = $$build ImmortalSnailEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ImmortalSnailEditor.commands = $$build ImmortalSnailEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	ImmortalSnail-Linux-Debug \
	ImmortalSnail-Linux-DebugGame \
	ImmortalSnail-Linux-Shipping \
	ImmortalSnail-Linux-Test \
	ImmortalSnail \
	ImmortalSnailEditor-Linux-Debug \
	ImmortalSnailEditor-Linux-DebugGame \
	ImmortalSnailEditor-Linux-Shipping \
	ImmortalSnailEditor-Linux-Test \
	ImmortalSnailEditor \
