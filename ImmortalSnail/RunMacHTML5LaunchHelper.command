...
EPIC_MONO=""
if [ -f "/mnt/Texas/prj/ue4-4.24.3-html5/Engine/Build/BatchFiles/Mac/SetupMono.sh" ]; then
    pushd "/mnt/Texas/prj/ue4-4.24.3-html5/Engine/Build/BatchFiles/Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'/mnt/Texas/prj/ue4-4.24.3-html5/Engine/Build/BatchFiles/Mac/SetupMono.sh';
fi
