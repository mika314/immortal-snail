...
ImmortalSnail-Linux-Debug:
	 $(PROJECTBUILD) ImmortalSnail Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnail-Linux-DebugGame:
	 $(PROJECTBUILD) ImmortalSnail Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnail-Linux-Shipping:
	 $(PROJECTBUILD) ImmortalSnail Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnail-Linux-Test:
	 $(PROJECTBUILD) ImmortalSnail Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnail:
	 $(PROJECTBUILD) ImmortalSnail Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnailEditor-Linux-Debug:
	 $(PROJECTBUILD) ImmortalSnailEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnailEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ImmortalSnailEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnailEditor-Linux-Shipping:
	 $(PROJECTBUILD) ImmortalSnailEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnailEditor-Linux-Test:
	 $(PROJECTBUILD) ImmortalSnailEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ImmortalSnailEditor:
	 $(PROJECTBUILD) ImmortalSnailEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
